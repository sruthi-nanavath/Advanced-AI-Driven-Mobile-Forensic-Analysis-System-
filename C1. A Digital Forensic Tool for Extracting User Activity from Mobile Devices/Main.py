...
main = tkinter.Tk()
main.title("A Digital Forensic Tool for Extracting User Activity from Mobile Devices")
...
font = ('times', 16, 'bold')
title = Label(main, text='A Digital Forensic Tool for Extracting User Activity from Mobile Devices')
...
featureselectionButton = Button(main, text="Forensic Activity", command=forensicsActivity)
